...
let canvasform = document.getElementById("animeCanvas");
...
//Load the file
loader.load(`just_a_girl/scene.gltf`, function (gltf) {
...
document.getElementById("animeCanvas").appendChild(renderer.domElement);
